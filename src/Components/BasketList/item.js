...
import { Button, Container, Text, Price, Quantity, Name, PickerContainer } from '../styled/general';
...
export const renderHeader = ({ name, uri, combination: { price }, quantity }) => (
	<HeaderWrapper>
		...
		<HeaderQuantity>
			<Text style={{ color: '#000', fontWeight: '300', marginRight: 8, fontSize: 20 }}>x</Text>
			{quantity}
		</HeaderQuantity>
	</HeaderWrapper>
);
		...
		<ContentWrapper>
			...
			<DualContent>
				...
				<QuantityContainer>
					...
					>
						<Text style={{ textAlign: 'center', fontSize: 26, fontWeight: '300', color: '#FFF' }}>-</Text>
					</Button>
